...
exports.first1621850092030 = void 0;
class first1621850092030 {
    constructor() {
        this.name = 'first1621850092030';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query("CREATE TABLE `order` (`id` int NOT NULL AUTO_INCREMENT, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `phone` int NOT NULL, `paymentMethod` varchar(255) NOT NULL, `status` varchar(255) NOT NULL, `address` varchar(255) NOT NULL, `notes` varchar(255) NULL, `prize` decimal(12,2) NOT NULL DEFAULT '0.00', `order_to_name` varchar(255) NOT NULL, `userId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `user` (`id` int NOT NULL AUTO_INCREMENT, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), `email` varchar(255) NOT NULL, `firstName` varchar(255) NULL, `lastName` varchar(255) NULL, `password` varchar(255) NOT NULL, `salt` varchar(255) NOT NULL, `phone` varchar(255) NULL DEFAULT '', `role` enum ('ADMIN', 'USER') NOT NULL DEFAULT 'USER', UNIQUE INDEX `IDX_e12875dfb3b1d92d7d7c5377e2` (`email`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
...
exports.first1621850092030 = first1621850092030;
//# sourceMappingURL=1621850092030-first.js.map